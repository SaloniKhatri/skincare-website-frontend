...
import Image1 from '../assets/images/BSectionStrawberry5.png'
...
import Image8 from '../assets/images/LimeFacewash.png'
        ...
        <>
            ...
            <div className='grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mx-auto gap-y-8'>
                <div className='border border-gray-100 rounded-lg m-4 shadow-lg w-75'>
                    ...
                    <div className='p-2'>
                        <p className='font-bold h-15'>Strawberry Bright 10% Niacinamide Face Serum</p>
                        ...
                        <div className='flex flex-row space-x-2 items-center mt-2 text-sm'>
                            ...
                            <div><p className='text-gray-600 font-semibold'>(19)</p></div>
                        </div>

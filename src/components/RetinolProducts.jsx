...
import Image10 from '../assets/images/BestsellerProduct10.png'
import Image1 from '../assets/images/DryProduct15.png'
import Image2 from '../assets/images/BSectionPomegranate9.png'

import { AiFillStar } from "react-icons/ai";


const RetinolProducts = () => {
    ...
    <>
      <div className='grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mx-auto gap-y-8'>
        ...
        <div className='border border-gray-100 rounded-lg m-4 shadow-lg w-75'>
          ...
          <div className='p-2'>
            <p className='font-bold h-15'>Retinol Night Repair Cream with Ceramides</p>
            <p className='pt-1 text-xs text-gray-600 mt-1 font-semibold'>Normal & Oily Skin</p>
            <div className='flex flex-row space-x-2 items-center mt-2 text-sm'>
              ...
              <div><p className='text-gray-600 font-semibold'>(652)</p></div>
            </div>
...
export default RetinolProducts